...
use {
  api::Api,
  bitcoin::{
    blockdata::block::BlockHeader as Header,
    blockdata::script,
    ...
    util::key::{KeyPair, Secp256k1, XOnlyPublicKey},
    Amount, Block, Network, OutPoint, Script, Sequence, Transaction, TxIn, TxOut, Txid,
